export const config = [
    {
        ...
        text: [{
            ...
            cmdKwargs: [{
                ...
                cmd: "composeUp",
                detach: false,
                composePath: './examples/yesterday_once_more/Y01_bgp_prefix_hijacking/demo_zju/output',
...
docker exec as199brd-attacker-bgp-10.199.0.254 birdc configure</pre>
                ...
                cmdKwargs: [
                    ...
                    },
                    {
                        ...
                        srcPath: './examples/yesterday_once_more/Y01_bgp_prefix_hijacking/demo_zju/Jupyter/as199_bird_include.conf_original',
            ...
            },
            {
                ...
                <div class="code-block">
                    <div class="code-header"><span class="code-title">命令</span></div>
                    <pre class="code-content">docker exec as3brd-r103-10.103.0.3 ip route | grep -E '58\\.205|222\\.192|10\\.203|118\\.228'</pre>
                </div>`,
                cmdKwargs: [
                    {
                        action: 'exec',
                        containerNames: ['as3brd-r103-10.103.0.3'],
                        cmd: "ip route | grep -E '58\\.205|222\\.192|10\\.203|118\\.228'",
                        detach: false
                    },
                ]
            },
                ...
                cmdKwargs: [
                    {
                        ...
                        srcName: '',
                        dstName: 'as199brd-attacker-bgp-10.199.0.254',
                        srcPath: './examples/yesterday_once_more/Y01_bgp_prefix_hijacking/demo_zju/Jupyter/as199_bird.conf_original',
                        dstPath: '/etc/bird/bird.conf',
                        detach: false
                    },
                    {
