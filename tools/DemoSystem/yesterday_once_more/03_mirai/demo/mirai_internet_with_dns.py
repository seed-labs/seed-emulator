...
from examples.yesterday_once_more.Y03_mirai.demo import mini_internet_for_mirai, dns_component
import os, sys
...
def run(dumpfile=None):
    ...
    dns = emuB.getLayer("DomainNameService")
    dns.getZone('com.').addRecord('worm.com. 1 IN  A  0.0.0.0')
    ...
    # root-a: 10.150.0.53
    # com-a: 10.151.0.53
    # local-dns-1: 10.152.0.53
    # local-dns-2: 10.153.0.53
    ...
    if dumpfile is not None:
        ...
        emu.compile(docker, './demo_output', override=True)
        os.system('cp -r ../container_files/mirai-base ./demo_output')
