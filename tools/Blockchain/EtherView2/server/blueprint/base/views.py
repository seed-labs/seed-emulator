import os
from flask import Blueprint, send_from_directory, redirect, current_app as app
...
# 静态资源路由
@base.route(f'{Config.STATIC_ASSET_PREFIX}/assets/<path:filename>')
...
@base.route(f'{Config.STATIC_ASSET_PREFIX}/<string:filename>')
...
@base.route(Config.URL_PREFIX, defaults={'path': ''})
@base.route(f'{Config.URL_PREFIX}/<path:path>')
