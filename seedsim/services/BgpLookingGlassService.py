from seedsim.core import Node, Service, Server, Simulator, ScopedRegistry
from seedsim.layers.Routing import Router
...
class BgpLookingGlassServer(Server):
    ...
    def bind(self, simulator: Simulator):
        """!
        @brief bind to the given simulator object; this will be called by the
