...
class Hook(Registrable, Printable):
    ...
    def preconfigure(self, simulator: Simulator):
        """!
    ...
    def postconfigure(self, simulator: Simulator):
        """!
    ...
    def prerender(self, simulator: Simulator):
        """!
    ...
    def postrender(self, simulator: Simulator):
        """!
