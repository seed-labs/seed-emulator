...
class InternetExchange(Printable):
    ...
    def __init__(self, simulator: Simulator, id: int, prefix: str = "auto", aac: AddressAssignmentConstraint = None):
        ...
        self.__rs = self.__reg.register('rs', name, Node(simulator, name, NodeRole.RouteServer, self.__id))
        self.__net = self.__reg.register('net', name, Network(simulator, name, NetworkType.InternetExchange, network, aac))
