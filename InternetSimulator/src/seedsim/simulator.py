...
class Simulator():
   ...
   def createHostDockerFiles(self):
       for k, (hostname, host) in enumerate(self.hosts.items()): 
           ...
           os.system("cp -rf {}/* {}/".format(SimConstants.TEMPLATE_HOSTDIR, dirname))
   ...
   def createRouterDockerFiles(self):
       for k, (routername, router) in enumerate(self.routers.items()): 
           ...
           os.system("mkdir -p {}".format(dirname))
           os.system("cp -rf {}/* {}/".format(SimConstants.TEMPLATE_ROUTERDIR, dirname))
                ...
                for i in range(10): 
                    ...
                    if row[col]: 
                        ...
                        if not peer1 or not peer2 or not ixp:
                            print("AS or IXP does not exist! {} {} {}".format(peer1_name, peer2_name, ixp_name))
                        ...
                        router2 = self.addBGPRouter(peer2_asn, ixp_asn, peer2_type)
