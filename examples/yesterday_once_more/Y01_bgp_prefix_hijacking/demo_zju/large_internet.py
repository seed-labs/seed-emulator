...
def run(dumpfile=None, hosts_per_as=2): 
    ...
    aszju = base.createAutonomousSystem(88888)
    aszju.createRealWorldRouter(name='real-world-zju', prefixes=['58.205.0.0/16', '222.192.0.0/16', '10.203.0.0/16'])\
          .joinNetwork('ix103', address = '10.103.0.177')
    ebgp.addPrivatePeerings(103, [3],  [88888], PeerRelationship.Provider)
    ...
    if dumpfile is not None: 
        ...
        emu.compile(docker, './output2', override=True)

if __name__ == "__main__":
    run(dumpfile='./large_internet.bin')
