...
def run():
    ...
    # Manually add records to ensure reachability
    dns_auth.getZone('qq.com.') \
            .addRecord('@ MX 10 mail.qq.com.') \
            .resolveToVnode('mail', 'mail-qq')
    ...
    dns_auth.getZone('gmail.com.') \
            .addRecord('@ MX 10 mail.gmail.com.') \
            .resolveToVnode('mail', 'mail-gmail')
