...
traffic_service.install('iperf-generator', TrafficServiceType.IPERF_GENERATOR).\
...
emu.addBinding(Binding('iperf-receiver-1', filter = Filter(asn = 162, nodeName='iperf-receiver-1')))
