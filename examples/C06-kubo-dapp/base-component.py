...
Makers.makeStubAsWithHosts(emu, base, 150, 100, numHosts)
Makers.makeStubAsWithHosts(emu, base, 151, 100, numHosts)

# Makers.makeStubAs(emu, base, 152, 101, [None, None])
# Makers.makeStubAs(emu, base, 153, 101, [web, None, None])
Makers.makeStubAsWithHosts(emu, base, 152, 101, numHosts)
Makers.makeStubAsWithHosts(emu, base, 153, 101, numHosts)

# Makers.makeStubAs(emu, base, 154, 102, [None, web])
Makers.makeStubAsWithHosts(emu, base, 154, 102, numHosts)
...
Makers.makeStubAsWithHosts(emu, base, 160, 103, numHosts)
Makers.makeStubAsWithHosts(emu, base, 161, 103, numHosts)
Makers.makeStubAsWithHosts(emu, base, 162, 103, numHosts)

# Makers.makeStubAs(emu, base, 163, 104, [web, None])
# Makers.makeStubAs(emu, base, 164, 104, [None, None])
Makers.makeStubAsWithHosts(emu, base, 163, 104, numHosts)
Makers.makeStubAsWithHosts(emu, base, 164, 104, numHosts)

# Makers.makeStubAs(emu, base, 170, 105, [web, None])
# Makers.makeStubAs(emu, base, 171, 105, [None])
Makers.makeStubAsWithHosts(emu, base, 170, 105, numHosts)
Makers.makeStubAsWithHosts(emu, base, 171, 105, numHosts)
