...
# These hostnames are already set up in examples/blockchain/D00_ethereum_poa or examples/blockchain/D01_ethereum_pos
...
def run(dumpfile = None):
    ...
    # These hostnames are already set up in D00_ethereum_poa or D01_ethereum_pos
    if consensus == 'pos':
    ...
    as_  = base.getAutonomousSystem(164)
