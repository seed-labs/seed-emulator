...
def run(dumpfile=None):
    ...
    # All email providers peer with ISP (private provider peerings)
    ...
    # Add RS peering at IX-100 to improve reachability and simplify route exchange
    # The RS sessions are non-transit (Peer), exporting own and customer routes only
    ebgp.addRsPeers(100, [2, 150, 151, 152, 160, 161])
