...
# from .EthTemplates.EthBeaconChainGenesisFileTemplates import *
# from .EthTemplates.Eth1GenesisFileTemplates import *
...
class EthereumServer(Server):
    ...
    def install(self, node: Node, eth: EthereumService):
        ...
        # genesis
        node.appendStartCommand('[ ! -e "/root/.ethereum/geth/nodekey" ] && geth --datadir {} init /tmp/eth1-genesis.json'.format(self._data_dir))
...
class PoSServer(PoAServer):
    ...
    def _generateGethStartCommand(self, addr:str):
        self._geth_options['pos'] = GethCommandTemplates['pos'].format()
        super()._generateGethStartCommand(addr)
