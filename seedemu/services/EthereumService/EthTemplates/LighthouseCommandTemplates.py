...
# data=`cat /tmp/vc/local-testnet/eth-{eth_id}/validators/0x*/eth1-deposit-data.rlp | cut -d '#' -f 1`
# geth --exec "eth.sendTransaction({{from: eth.accounts[0], to: '$contract_address', value: '32000000000000000000', data: '$data'}})" attach
# """
...
# data=`cat /tmp/vc/local-testnet/testnet/validators/0x*/eth1-deposit-data.rlp | cut -d '#' -f 1`
# geth --exec "eth.sendTransaction({from: eth.accounts[0], to: '$contract_address', value: '32000000000000000000', data: '$data'})" attach
...
# contract_address="0x00000000219ab540356cBB839Cbe05303d7705Fa"
# data=$(cat /tmp/vcnode/local-testnet/testnet/validators/0x*/eth1-deposit-data.rlp | cut -d '#' -f 1)
# from_addr=$(geth attach --exec "eth.accounts[0]")

# geth attach --exec "eth.sendTransaction({from: '$from_addr', to: '$contract_address', value: '32000000000000000000', data: '$data'})"
