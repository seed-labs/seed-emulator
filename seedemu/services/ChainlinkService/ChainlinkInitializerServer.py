...
class ChainlinkInitializerServer(Server):
    ...
    def __deployThroughWeb3(self):
        ...
        self.__node.setFile('/contracts/deploy_linktoken_contract.py', LinkTokenDeploymentTemplate['link_token_contract'].format(rpc_url = self.__rpc_url, private_key = self.__owner_private_key, rpc_port = self.__rpc_port))
