...
test_num_nodes = [10, 30, 50, 100, 300, 500, 1000]
test_iterations = [1, 5, 10]

# "v2v-urban", "v2v-highway"
propagation_loss_model = ["v2v-urban", "v2v-highway"]

for scenario in propagation_loss_model:
    csv_file = './{}-seed-test.csv'.format(propagation_loss_model)
