...
as3.createRouter('r5').joinNetwork('net3').joinNetwork('net2')
for i in range(0, 10):
    as3.createHost('host{}'.format(i)).joinNetwork('net3')
###############################################################################
...
for i in range(2, 10):
    as151.createHost('host{}'.format(i)).joinNetwork('net0')
...
for i in range(0, 10):
    as152.createHost('host{}'.format(i)).joinNetwork('net0')
# Install additional software on a host
