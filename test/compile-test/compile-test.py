...
class CompileTest(ut.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.test_list = {
            ...
            "B13-iperf-traffic-generator" : (["iperf-traffic-generator.py"], ["output"]),
            "B14-ditg-traffic-generator" : (["ditg-traffic-generator.py"], ["output"]),
            "B15-scapy-traffic-generator" : (["scapy-traffic-generator.py"], ["output"]),
            "B16-hybrid-traffic-generator" : (["hybrid-traffic-generator.py"], ["output"]),
