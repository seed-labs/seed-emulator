...
class CompileTest(ut.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.test_list = {
            ...
            "B13-traffic-generator/0-iperf-traffic-generator" : (["iperf-traffic-generator.py"], ["output"]),
            "B13-traffic-generator/1-ditg-traffic-generator" : (["ditg-traffic-generator.py"], ["output"]),
            "B13-traffic-generator/2-scapy-traffic-generator" : (["scapy-traffic-generator.py"], ["output"]),
            "B13-traffic-generator/3-hybrid-traffic-generator" : (["hybrid-traffic-generator.py"], ["output"]),
