...
**日期**: 2026-08-09 18:11:59

## 测试汇总

- **Agent 类型**: rule
- **控制台日志**: `/home/zvanadium/seed-emulator/benchmarks/logs/BENCHMARK_CLI_20260809_181055_4142015.log`
- **测试模式**: 盲测
...
|------|------|------|----------|----------|----------|----------|
| 1 | gen_bird_wrong_asn_860f532665_01 | B00_mini_internet | wrong_asn | unknown | ✗ | ✓ |
