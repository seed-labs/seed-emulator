...
**日期**: 2026-08-12 19:08:05

## 测试汇总

- **Agent 类型**: rule
- **控制台日志**: `/home/zvanadium/seed-emulator/benchmarks/logs/BENCHMARK_CLI_20260812_190653_861442.log`
- **测试模式**: 盲测
...
|------|------|------|----------|----------|----------|----------|
| 1 | gen_bird_wrong_asn_9695fab1eb_01 | DECLARATIVE_small_ring | wrong_asn | unknown | ✗ | ✓ |
