...
def builtin_registry(fault_drivers: Iterable[str] = ()) -> PluginRegistry:
    ...
    for descriptor in (
        ...
        PluginDescriptor("probe.hostname", "probe", "1.0.0", ("docker",), supports_sampling=True),
        PluginDescriptor("probe.icmp", "probe", "1.0.0", ("docker",), supports_sampling=True),
        PluginDescriptor("probe.ipv6_route", "probe", "1.0.0", ("docker",), supports_sampling=True),
        PluginDescriptor("probe.docker_network", "probe", "1.0.0", ("docker",)),
        PluginDescriptor(
            "probe.docker_network_path", "probe", "1.0.0", ("docker",),
            supports_sampling=True,
        ),
        PluginDescriptor("probe.executable", "probe", "1.0.0", ("docker",)),
